...
async def download_feo_template():
    ...
    headers = [
        ...
        "Кол-во (Ур.2)",                                 # C
        "Ед. изм. (Ур.2)",                               # D
        "Стоимость за ед. (Ур.2)",                       # E  ← NEW
        "Уровень 3 (Тип расходов по ФЭО)",               # F
        "Кол-во (Ур.3)",                                 # G
        "Ед. изм. (Ур.3)",                               # H
        "Стоимость за ед. (Ур.3)",                       # I  ← NEW
        "Уровень 4 (Конкретизированный)",                # J
        "Кол-во (Ур.4)",                                 # K
        "Ед. изм. (Ур.4)",                               # L
        "Стоимость за ед. (Ур.4)",                       # M  ← NEW
        "Уровень 5 (Плановый товар/услуга)",             # N
        "Количество (Ур.5)",                             # O
        "Ед. измерения (Ур.5)",                          # P
        "Стоимость за ед. (Ур.5)",                       # Q
        "Код",                                           # R
        "Приложение",                                    # S
        "Финансирование",                                # T
        "Активна",                                       # U
