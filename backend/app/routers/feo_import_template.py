...
async def download_feo_template(
    ...
    if DataValidation is not None:
        ...
        dv_item_type.promptTitle = "Тип (товар/услуга/работа)"
    ...
    rules = [
        ...
        "7. «Тип (товар/услуга/работа)» (колонка 6) — тип плановой позиции: Товар, Услуга или Работа (выпадающий список в ячейке).",
