...
<required_reading>
@c:/Users/1/Desktop/Cursor/VSKS_CRM/.claude/get-shit-done/references/domain-probes.md
@c:/Users/1/Desktop/Cursor/VSKS_CRM/.claude/get-shit-done/references/gate-prompts.md
@c:/Users/1/Desktop/Cursor/VSKS_CRM/.claude/get-shit-done/references/universal-anti-patterns.md
</required_reading>
...
if [ -f "c:/Users/1/Desktop/Cursor/VSKS_CRM/.claude/get-shit-done/USER-PROFILE.md" ]; then
  ADVISOR_MODE=true
else
  ADVISOR_MODE=false
fi
...
Read `@c:/Users/1/Desktop/Cursor/VSKS_CRM/.claude/get-shit-done/references/scout-codebase.md` — it contains the phase-type→map selection table, single-read rule, no-maps fallback, and `<codebase_context>` output schema. Then execute:
