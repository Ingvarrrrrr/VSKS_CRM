 ...
 *                        Имена построчно синхронизированы с backend/app/services/ru_regions.py;
 *                        порядок и написание не менять без обновления бэкенда.
 *
...
export const RU_SUBJECTS_89: string[] = [
  'Алтайский край',
  'Амурская область',
