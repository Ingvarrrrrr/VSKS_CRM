...
TEMPLATE_VARIABLES = [
    ...
    ("{{item.form_summary}}", "То же, пример для «Питание»", "{{item.form_summary}}",
    ...
    ("{{item.extra.meals_per_day}}", "Питание: приёмов пищи в день (по умолчанию 3)", "{{item.extra.meals_per_day}}", "3"),
