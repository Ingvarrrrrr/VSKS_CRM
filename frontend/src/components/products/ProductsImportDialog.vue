        ...
        <template v-if="wizard.importDialog.step === 1">
          <v-alert type="info" variant="tonal" density="compact" class="mb-3" icon="mdi-information-outline">
            <div class="text-body-2">
              Колонки файла уже подобраны — на следующем шаге останется
              проверить и, если нужно, поправить сопоставление.<br>
              Заполните поле «Наименование»: без него товар не сохранится.
            </div>
          </v-alert>
          <v-file-input
