...
**Plans:** TBD (предположительно 8-10 планов: model+миграция, импорт реестра, CRUD+карточка, фото+документы, ремонты, пробег+топливо+заправки, водители (User extension), путёвки docxtpl, дашборд, уведомления о просрочке)
