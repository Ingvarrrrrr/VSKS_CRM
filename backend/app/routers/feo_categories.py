...
async def download_feo_template():
    ...
    headers = [
        ...
        "Кол-во (Ур.2)",                                 # C
        "Ед. изм. (Ур.2)",                               # D  ← NEW
        "Уровень 3 (Тип расходов по ФЭО)",               # E
        "Кол-во (Ур.3)",                                 # F
        "Ед. изм. (Ур.3)",                               # G  ← NEW
        "Уровень 4 (Конкретизированный)",                # H
        "Кол-во (Ур.4)",                                 # I
        "Ед. изм. (Ур.4)",                               # J  ← NEW
        "Уровень 5 (Плановый товар/услуга)",             # K
        "Количество (Ур.5)",                             # L
        "Ед. измерения (Ур.5)",                          # M
        "Сумма плановая (Ур.5)",                         # N
        "Код",                                           # O
        "Приложение",                                    # P
        "Финансирование",                                # Q
        "Активна",                                       # R
    ...
    for i, w in enumerate([18, 42, 12, 14, 42, 12, 14, 45, 12, 14, 45, 12, 14, 18, 10, 12, 18, 10], 1):
