...
export interface FeoMatchCandidate {
   ...
   *  ветки предков). Требование /feo-planned-items/map — совпадение категорий
   *  обязательно, поэтому такие кандидаты показываются ОТДЕЛЬНОЙ группой с пометкой,
   *  не подмешиваются молча к «своим». */
